        ...
        <div className="w-full md:w-64 bg-zinc-50 dark:bg-zinc-950/40 p-8 border-b md:border-b-0 md:border-r border-zinc-200/60 dark:border-zinc-800/60">
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider">{t("role")}</p>
            </div>
            ...
            <div className="w-full pt-6 space-y-4 text-left">
               <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">{t("tech")}</h3>
        ...
        <div className="flex-1 p-8 md:p-10 space-y-8 overflow-y-auto custom-scrollbar">
           ...
           <section className="space-y-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xs font-black uppercase tracking-[0.15em] text-zinc-500 dark:text-zinc-400">{t("exec")}</h3>
              </div>
           ...
           <section className="space-y-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xs font-black uppercase tracking-[0.15em] text-zinc-500 dark:text-zinc-400">{t("work")}</h3>
              </div>
           ...
           <section className="space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xs font-black uppercase tracking-[0.15em] text-zinc-500 dark:text-zinc-400">{t("edu")}</h3>
              </div>
